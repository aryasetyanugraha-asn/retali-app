...
import { Download, Image as ImageIcon, Type, Trash2 } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/3 flex flex-col gap-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex flex-col gap-3">
            ...
            {selectedId && elements.find(el => el.id === selectedId)?.type === 'TEXT' && (
                <div className="mt-2">
                    <span className="text-xs font-medium text-gray-500 mb-1 block">Edit Text</span>
                    <input
                        type="text"
